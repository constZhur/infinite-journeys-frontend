                    ...
                    <Form.Item label={"Текущая роль"}>
                        {
                            selectedForChangeRole?.role === "ROLE_ADMIN" ? <Tag color="red">Администратор</Tag> :
                                selectedForChangeRole?.role === "ROLE_SELLER" ? <Tag color="orange">Модератор</Tag> :
                                    selectedForChangeRole?.role === "ROLE_BUYER" ?
                            ...
                            >
                                <Select
                                    ...
                                    options={[
                                        ...
                                        {
                                            label: <Tag color="orange">Продавец</Tag>,
                                            value: 'ROLE_SELLER',
                                        },
                                        {
                                            label: <Tag color="blue">Покупатель</Tag>,
                                            value: 'ROLE_BUYER',
                                        }
                                    ]}
                                />
                            ...
                            // }
                            {
                                ...
                                render: (role) => {
                                    if (role === "ROLE_ADMIN") {
                                        ...
                                        return <Tag color="orange">Продавец</Tag>
                                    } else if (role === "ROLE_BUYER") {
                                        return <Tag color="blue">Покупатель</Tag>
                                    }
                                }
                            },
                            {
